...
- `EMBEDDINGS_PROVIDER`: (Optional) either "openai", "bedrock", "azure", "huggingface", "huggingfacetei", "ollama" or "voyageai", where "huggingface" uses sentence_transformers; defaults to "openai"
...
- `VOYAGEAI_API_KEY`: (Optional) needed for voyageai embeddings
