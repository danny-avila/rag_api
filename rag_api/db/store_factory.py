...
from rag_api.db.store import AsyncPgVector, AtlasMongoVector, ExtendedPgVector
...
def get_vector_store(
    ...
    if mode == "sync":
        ...
        return AtlasMongoVector(
            collection=mong_collection, embedding=embeddings, index_name=collection_name
        )
